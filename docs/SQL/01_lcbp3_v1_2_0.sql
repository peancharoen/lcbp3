...
-- cron service: n8n
-- DMS v1.2.0 Improvements
-- Update:
-- 1. ปรับปรุง Seed Roles, Permissions, and Role-Permissions Mapping
-- 2. ปรับปรุงตาราง: correspondence_revisions, rfa_revisions
-- 3. เพิ่ม ตาราง: document_number_formats, document_number_counters
-- 4. สร้าง Stored Procedure ใหม่ (สำหรับ Document Numbering) sp_get_next_document_number
-- 5. สร้าง Views: v_user_tasks, v_audit_log_details, v_user_all_permissions
-- ==========================================================
