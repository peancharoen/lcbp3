...
- [x] `specs/04-Infrastructure-OPS/04-00-docker-compose/Desk-5439/` — Modelfiles สำหรับ Ollama (`np-dms-ai`, `np-dms-ocr`)
- [x] `specs/04-Infrastructure-OPS/04-00-docker-compose/QNAP/` — legacy compose ที่ยังใช้สำหรับ NPM
