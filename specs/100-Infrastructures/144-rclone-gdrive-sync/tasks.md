...
- [X] T016 [US3] สร้าง Push Monitor `rclone - Backup repo` ใน Uptime Kuma UI — Monitor Type: Push, Heartbeat Interval: ~1500 วินาที (มากกว่ารอบ cron daily เล็กน้อย) — บันทึก Push URL และ token `RD64Hz4JdgbWKAJLoLVGHjDmjowMwfHi`
- [X] T017 [US3] สร้าง Push Monitor `rclone - Specs sync` ใน Uptime Kuma UI — Heartbeat Interval: ~9000 วินาที (มากกว่ารอบ cron 2 ชม. เล็กน้อย) — บันทึก Push URL และ token `va1hlAh8fawmq1nfjZAkoMCncx907wZX`
...
- [X] T020 [US1] เพิ่ม Job A (Backup repo 01:00 daily พร้อม Uptime Kuma push):
  ```cron
  ...
  ```
- [X] T021 [US2] เพิ่ม Job B (Sync specs 08-18 ทุก 2 ชม. พร้อม Uptime Kuma push):
  ```cron
