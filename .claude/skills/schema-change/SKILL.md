...
3. **Identify impact scope** — determine which tables, columns, indexes, or constraints are affected. List:
...
4. **Modify schema SQL** — edit `specs/03-Data-and-Storage/lcbp3-v1.9.0-schema-02-tables.sql`:
...
6. **Update seed data** (if applicable):
   - `specs/03-Data-and-Storage/lcbp3-v1.9.0-seed-basic.sql` — for reference/lookup data
   - `specs/03-Data-and-Storage/lcbp3-v1.9.0-seed-permissions.sql` — for new CASL permissions
...
9. **Run type check** — verify no TypeScript errors:
