---
name: 112-speckit.security-audit
...
3. Read `specs/03-Data-and-Storage/lcbp3-v1.9.0-seed-permissions.sql` for CASL permission definitions
...
1. **Load permission matrix** from `specs/03-Data-and-Storage/lcbp3-v1.9.0-seed-permissions.sql`
