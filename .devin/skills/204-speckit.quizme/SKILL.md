...
Goal: Act as a "Red Team" or "Socratic Teacher" to challenge the current feature specification. Unlike `103-speckit.clarify` (which looks for missing definitions), `204-speckit.quizme` looks for logical fallacies, race conditions, naive assumptions, and "happy path" bias.
