...
# create-backend-module — NestJS Module Scaffold

> 📌 See [`_LCBP3-CONTEXT.md`](../_LCBP3-CONTEXT.md) for LCBP3-specific conventions.

Use this skill when creating a new feature module in `backend/src/modules/`.
...
2. **Check schema** — read `specs/03-Data-and-Storage/lcbp3-v1.9.0-schema-02-tables.sql` for relevant tables
