# ⚠️ ARCHIVED — ห้ามใช้เป็นกฎ

> **นี่คือ audit trail ไม่ใช่ policy**
>
> - **ที่มา:** `.gemini/GEMINI.md` ก่อนแปลงเป็น thin adapter (2026-08-11)
> - **เนื้อหา:** สำเนาเต็มของ `AGENTS.md` **v1.9.10** (2026-06-06)
> - **สถานะ:** 🔴 DRIFT — ใช้ [`../../AGENTS.md`](../../AGENTS.md) (v1.10.0+) เท่านั้น
>
> **Drift ที่ตรวจพบ 2026-08-11:**
>
> - ระบุ "Ollama บน Admin Desktop" — ขัด **ADR-041 D1** (ของจริงคือ `np-dms-lcbp3`)
> - อ้าง `(ADR-009)` กับกฎ no-migration — canonical คือ **ADR-044**
> - ไม่มี **ADR-045** (edge topology; QNAP ไม่รัน Docker แล้ว)
> - ไม่มี **LCBP3 Agent Execution Contract §1-9**

---

# NAP-DMS Project Context & Rules (snapshot v1.9.10)
