...
5. **Generate checklist** - Create "Unit Tests for Requirements":
   ...
   - Each `/205-speckit-checklist` run creates a NEW file (never overwrites existing checklists)
...
**Important**: Each `/205-speckit-checklist` command invocation creates a checklist file using short, descriptive names unless file already exists. This allows:
