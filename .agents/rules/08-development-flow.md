...
| "ดู logs / debug ops"       | `specs/100-Infrastructures/145-server-cli-tools/quickstart.md`                        | ใช้ `lazydocker` (TUI), `lnav` (parse Docker/NestJS logs), `dust`/`duf` (disk) — ติดตั้งแล้วบน np-dms-lcbp3 |
